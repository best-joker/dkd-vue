  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary"  @click="handleUpdate(scope.row)" v-hasPermi="['manage:type:edit']">修改</el-button>
          <el-button link type="primary"  @click="handleDelete(scope.row)" v-hasPermi="['manage:type:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="typeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="货道数" prop="vmRow">
          <el-input-number v-model="form.vmRow" :max="10" :min="1"  />&nbsp;行 &nbsp;&nbsp;
          <el-input-number v-model="form.vmCol"  :max="10" :min="1" />&nbsp;列
        </el-form-item>
        <el-form-item label="设备容量" prop="channelMaxCapacity">
          <el-input-number v-model="form.channelMaxCapacity" :max="10" placeholder="请输入设备容量" />
        </el-form-item>
...
import { listType, getType, delType, addType, updateType } from "@/api/manage/type";
...
function handleExport() {
  proxy.download('manage/type/export', {
    ...queryParams.value

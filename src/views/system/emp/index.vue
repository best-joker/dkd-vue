<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="empList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" align="center" type="index" prop="id" width="80px" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:emp:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:emp:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="empRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="负责区域" prop="id">
          <!-- <el-input v-model="form.regionId" placeholder="请输入所属区域Id" /> -->
           <el-select v-model="form.regionName" placeholder="请选择负责区域">
            <el-option
...
import{listRole}from "@/api/system/role1";
...
function handleExport() {
  proxy.download('system/emp/export', {
    ...queryParams.value

<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" type="index" align="center" prop="id"  width="80px" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary"  @click="handleUpdate(scope.row)" v-hasPermi="['system:node:edit']">修改</el-button>
          <el-button link type="primary"  @click="handleDelete(scope.row)" v-hasPermi="['system:node:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="nodeRef" :model="form" :rules="rules" label-width="100px" text-align="left">
...
function handleExport() {
  proxy.download('system/node/export', {
    ...queryParams.value
